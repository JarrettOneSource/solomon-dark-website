...
test('policy-driven headless step emits one strict main trajectory-v6 record', () => {
  ...
  assert.equal(rollout.record.trajectoryVersion, 6)
  assert.equal(rollout.record.observation.length, 2_738)
