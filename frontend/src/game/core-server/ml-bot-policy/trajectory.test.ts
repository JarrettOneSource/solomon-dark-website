...
test('policy-driven headless step emits one strict main trajectory-v5 record', () => {
  ...
  assert.equal(rollout.record.trajectoryVersion, 5)
  assert.equal(rollout.record.observation.length, 1_784)
