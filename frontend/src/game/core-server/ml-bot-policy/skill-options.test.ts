...
test('choice descriptors encode offered mechanics in exact 106-value rows', () => {
  ...
  assert.equal(described.descriptors.length, offer.options.length * 106)
