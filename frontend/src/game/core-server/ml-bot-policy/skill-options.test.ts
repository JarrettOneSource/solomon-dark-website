...
test('choice descriptors encode offered mechanics in exact 138-value rows', () => {
  ...
  assert.equal(described.descriptors.length, offer.options.length * 138)
