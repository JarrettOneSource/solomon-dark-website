...
export function createGameSnapshotFrame(
  ...
  return {
    ...
    world: {
      ...
      spiderSilks: snapshot.world.spiderSilks,
      silkFragments: snapshot.world.silkFragments,
      spiderRemains: snapshot.world.spiderRemains,
      webbedPlayers: snapshot.world.webbedPlayers,
  ...
  apply(frame: GameSnapshotFrame, sequence: number): GameClientSnapshot {
    ...
    return {
      ...
      world: {
        ...
        spiderSilks: frame.world.spiderSilks,
        silkFragments: frame.world.silkFragments,
        spiderRemains: frame.world.spiderRemains,
        webbedPlayers: frame.world.webbedPlayers,
