...
export const NATIVE_SECONDARY_ABILITY_CONTRACTS: readonly NativeSecondaryAbilityContract[] = Object.freeze([
  ...
  define({
    action: null,
    art: ['DeadHawg:46..77', 'DeadHawg:18', 'BadGuys:333..342'],
    audio: audio(
    ...
    timing: { angleStepDegrees: 12, segmentCount: 30, segmentRngWords: 7, shockwaveQueryPeriodTicks: 10 },
  }),
  define({
    action: null,
  ...
  define({
    action: null,
    art: ['DeadHawg:114,121', 'BadGuys:72'],
