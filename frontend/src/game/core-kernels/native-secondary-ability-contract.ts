...
export const NATIVE_SECONDARY_ABILITY_CONTRACTS: readonly NativeSecondaryAbilityContract[] = Object.freeze([
  ...
  define({
    ...
    audio: audio(
      ...
      sound('acid-sizzle', 'sounds/acidsizzle.wav', 'authoritative damage pulse with native pitch'),
      sound('rainfall-loop', 'sounds/rainfall__loop.wav', 'renew at cloud-alpha gain while cloud alpha is positive'),
    ),
    authority: 'Host owns the strict radius-200 root query, shuffled target selection, direct damage, drop identity, active clock, and residue.',
    cleanup: 'Cloud light and rainfall stop at zero cloud alpha; the actor retires only after the later residue fade.',
    name: 'Acid Rain',
    skillId: 72,
    targeting: 'aimed-world-point-strict-radius-200',
    timing: {
      activeTicks: 1_500,
