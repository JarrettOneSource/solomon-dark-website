...
try {
  ...
  assert.match(await luthacusDialogue.innerText(), /resident scavenger/)
  ...
  await luthacus.getByRole('button', { name: 'Store' }).click()
  ...
  await luthacus.getByRole('button', { name: 'Take' }).click()
